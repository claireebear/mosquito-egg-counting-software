    ...
    <v-card-title>
      <v-layout align-center wrap>
        <v-flex>
          ...
          <v-layout col justify-space-between align-center>
            <v-flex shrink class="text-xs-center">
            <v-btn icon @click="previous">
              <img src="/img/left-arrow.png" alt="Previous" style="width: 24px; height: 24px;">
            </v-btn>
          </v-flex>
          <v-flex shrink class="text-xs-center">
            <v-btn icon @click="next">
              <img src="/img/right-arrow.png" alt="Next" style="width: 24px; height: 24px;">
            </v-btn>
          </v-flex>
          </v-layout>
        </v-flex>
